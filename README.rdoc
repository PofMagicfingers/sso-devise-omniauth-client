...
== Usage
    ...
    git clone git://github.com/pofmagicfingers/sso-devise-omniauth-client.git
    bundle install
    rake db:migrate
...
== To test single sign-on
    ...
    git clone git://github.com/pofmagicfingers/sso-devise-omniauth-client.git client1
    git clone git://github.com/pofmagicfingers/sso-devise-omniauth-client.git client2
